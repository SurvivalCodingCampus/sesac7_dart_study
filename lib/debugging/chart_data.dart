...
class ChartData {
  ...
  // 역직렬화 시 사용할 리스트.
  // jsonDecode 실행 시 Map value의 runtimeType이 List<dynamic>이므로 별도로 생성.
  ...
  ChartData.fromJson(Map<String, dynamic> json)
    // json['collectionChartDataList'] runtimeType이 List<dynamic>이므로,
    // _collectionChartDataList에 담지 않고 reverseSerializationList에 담는다.
