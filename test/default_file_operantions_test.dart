...
void main() {
  test('원본 파일 경로가 없는 경우 Throw 테스트', () {
    ...
    expect(() => DefaultFileOperations().copy(sourcePath: testOriginalFilePath, targetPath: testCopyFilePath), throwsException);
  });
  ...
  test('파일 복사 후 내용 비교', () {
    ...
    final String originalFileContent = File(testOriginalFilePath).readAsStringSync();
