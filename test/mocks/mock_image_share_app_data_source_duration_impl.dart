...
class MockImageShareAppDataSourceDurationImpl implements ImageShareAppUserDataSource {
  final http.Client _client;

  MockImageShareAppDataSourceDurationImpl(http.Client client) : _client = client;
