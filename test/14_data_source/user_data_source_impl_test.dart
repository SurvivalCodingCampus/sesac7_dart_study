...
void main() {
  ...
  group('UserDataSourceImpl 테스트', () {
    test('UserDataSourceImpl getUsers() 테스트', () async {
      final List<User> users = (await dataSource.getUsers()).sublist(0, 5);
      final List<User> testUsers = (jsonDecode(testJsonString) as List)
          .map((e) => User.fromJson(e as Map<String, dynamic>))
          .toList();

      expect(users, equals(testUsers));
    });
  });
}
